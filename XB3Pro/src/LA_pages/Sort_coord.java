...
public class Sort_coord {
	...
	public static void merge(double userLat, double userLng, business_coord[] a, business_coord[] aux, int lo, int mid, int hi) {
		int i = lo, j = mid+1;
	...
	public static void sortMerge (double userLan, double userLng, business_coord[] x, int n ) {
		business_coord[] aux = new business_coord[n];
